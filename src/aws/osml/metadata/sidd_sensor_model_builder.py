...
class SIDDSensorModelBuilder(SensorModelBuilder):
    ...
    def build(self) -> Optional[SensorModel]:
        ...
        try:
            ...
            sidd = sidd_parser.from_string(self.sidd_xml)
            return SIDDSensorModelBuilder.from_dataclass(sidd)
        except Exception as e:
            logging.error("Exception caught attempting to build SIDD sensor model. %s", e)
        return None
